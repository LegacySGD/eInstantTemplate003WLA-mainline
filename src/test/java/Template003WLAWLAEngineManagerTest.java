...
public class Template003WLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Template003WLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Template003WLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Template003WLAIW/InitOutcome.xml").getDocumentElement();
